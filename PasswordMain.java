...
public class PasswordMain extends BorderPane {
	...
	public void checkPassword() {
		...
		try {
			...
			PasswordCheckerUtility.comparePasswords(passwordString, passwordAString);
			...
			PasswordCheckerUtility.NoSameCharInSequence​(passwordString);
			PasswordCheckerUtility.isValidPassword​(passwordString);
			PasswordCheckerUtility.hasBetweenSixAndNineChars​(passwordString);
			PasswordCheckerUtility.isWeakPassword​(passwordString);
