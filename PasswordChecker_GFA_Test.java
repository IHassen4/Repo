...
public class PasswordChecker_GFA_Test {
	...
	@Test
	public void testIsValidPasswordSuccess() throws LengthException, NoUpperAlphaException, NoLowerAlphaException, NoDigitException, InvalidSequenceException
	{
		try{
	...
	@Test
	public void testIsValidPasswordTooShortThrowsSomeOtherExcep() throws NoUpperAlphaException, NoLowerAlphaException, NoDigitException, NoSpecialCharacterException, InvalidSequenceException
	{
		try{
